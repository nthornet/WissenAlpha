...
import os 
import sys 
import Includes.twitter
from Includes.twitter.oauth import write_token_file, read_token_file 
...
# Go to http://twitter.com/apps/new to create an app and get these items. # See also http://dev.twitter.com/pages/oauth_single_token
